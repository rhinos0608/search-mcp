   ...
   server.registerTool(
      'deep_research',
      {
         description:
            ...
            'Uses a 7-phase research pipeline (or tree-based recursive exploration for tree depth): ' +
            'query decomposition → parallel discovery → deep extraction → gap analysis → audit → synthesis. ' +
            'Supports quick, standard, deep, and tree depth profiles. ' +
