...
const STOP_WORDS = new Set([
  ...
  'them', 'than', 'that', 'this', 'with', 'will', 'what', 'when',
  'where', 'which', 'who', 'how', 'its', 'may', 'also', 'more',
  'very', 'just', 'only', 'over', 'such', 'each', 'about', 'into',
  'could', 'other', 'their', 'there', 'these', 'those', 'should',
  'would', 'after', 'being', 'does', 'down', 'own', 'too', 'any',
  'here', 'from', 'come', 'like', 'than', 'then', 'than', 'make',
  'more', 'most', 'much', 'same', 'some', 'such', 'than', 'them',
  'then', 'they', 'this', 'very', 'well', 'were', 'your', 'done',
  'even', 'many', 'said', 'made', 'know', 'need', 'part', 'used',
  'using', 'work', 'year', 'back', 'good', 'new', 'now', 'old',
  'way', 'get', 'got', 'see', 'first', 'last', 'long', 'must',
  'still', 'take', 'think', 'use', 'want', 'thing', 'things',
]);
...
export function applyIntentFilter<T>(
  ...
  interface Scored { item: T; score: number; matchedTerms: Set<string> };
  ...
  const searchableTerms = extractSearchableTerms(
