...
> **29 tools** for web search, semantic RAG, code analysis, job search, academic research, and social media — all in one MCP server.
...
- [Full Tool Reference](docs/tools.md) — Detailed docs for all 29 tools
