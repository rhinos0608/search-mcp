...
Config-gated: `web_crawl` (Crawl4AI), `semantic_crawl*` (Crawl4AI + embedding). Jobs acquisition is policy-gated in-process; family actions may also be individually gated.
...
| `semantic_crawl` | RAG pipeline over crawled corpus. Actions: crawl, list_corpora, inspect_corpus                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `jobs_search`    | Policy-gated in-process acquisition, extraction, constraints, and ranking                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| `jobs`           | search, capabilities, describe_action                                                                                                                                                                                                                                                                  |
|                  |
